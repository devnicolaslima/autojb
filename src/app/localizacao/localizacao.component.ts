...
export class LocalizacaoComponent implements OnInit {
  ...
  abrirLink(): void {
    window.open(
      'https://www.google.com/maps/place/AUTO+JB/@-29.931451,-51.0880416,17z/data=!4m6!3m5!1s0x951973a7b86023e7:0x24c98ba299e6676b!8m2!3d-29.9299719!4d-51.0865501!16s%2Fg%2F11q1s7pmrz?entry=ttu',
      '_blank'
    );
  }

  nextBanner() {
    this.bannerSelectedIndex =
      (this.bannerSelectedIndex + 1) % this.banners.length;
  }
  ...
  previousBanner() {
    this.bannerSelectedIndex =
      (this.bannerSelectedIndex + this.banners.length - 1) %
      this.banners.length;
  }
